...
class _ViewPostingPageState extends State<ViewPostingPage> {
  ...
  static LatLng _centerLatLong = const LatLng(49.2827, -123.1207);//NE +ve, SW -ve
  Completer<GoogleMapController> _completer;
  LatLng _lastMapPosition = _centerLatLong;

  void _calculateLatAndLng() {
    _centerLatLong = const LatLng(49.2827, -123.1207);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          title: AppBarTexts(text: 'Posting Information',),
        actions: <Widget>[
          IconButton(
